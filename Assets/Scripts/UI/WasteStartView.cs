...
public sealed class WasteStartView
{
    ...
    {
        return Create(startAction, null, null, null);
    }
        ...
        System.Action endlessScoreAction)
    {
        ...
        Text subtitleText = WasteUiFactory.CreateText(
            "Subtitle",
            panelRect,
            "推荐从标准闯关开始，先选择简单/中等/困难难度；也可开始游戏、体验限时挑战或生存刷分。",
            24,
            FontStyle.Normal,
        ...
        LayoutButton(timedChallengeButton, new Vector2(140f, 48f), timedChallengeAction != null);
    ...
    {
        Show(startAction, null, null, null);
    }
