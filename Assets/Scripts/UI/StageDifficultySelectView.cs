...
public sealed class StageDifficultySelectView
{
    ...
    public void Show(StageProgressionConfig config, Action<int> onSelectDifficulty, Action onBack)
    {
        ...
        SetStretch(hintText.rectTransform, new Vector2(56f, -140f), new Vector2(-56f, -88f), new Vector2(0f, 1f), new Vector2(1f, 1f));

        RectTransform listRect = WasteUiFactory.CreateRect("DifficultyList", panelRect);
        SetStretch(listRect, new Vector2(56f, 120f), new Vector2(-56f, -150f), Vector2.zero, Vector2.one);
        ...
        for (int i = 0; i < stageCount; i++)
        {
            ...
            CreateDifficultyButton(
                listRect,
                BuildDifficultyButtonLabel(stage, i),
    ...
    private static string BuildDifficultyButtonLabel(StageDefinition stage, int index)
    {
